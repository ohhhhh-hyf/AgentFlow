...
def main() -> None:
    ...
    try:
        ...
        print(f"  3. Run: python tools/codegen/sync_domain.py --domain {args.domain} --model")
        if args.with_report:
        ...
        print(f"  5. Run: python tools/codegen/sync_domain.py --domain {args.domain}")
        print(f"  6. Run: python tools/codegen/sync_domain.py --domain {args.domain} --check")
