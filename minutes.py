...
payload = {
    ...
    "task": "minutes",
    "texts": {
        "transcript": """周宁：今天主要复盘「小艺慧记Agent开发进展」第一阶段情况，确认8月下旬内测前必须收口的事项。当前整体进度大约完成60%，会议纪要、待办提取、风险分析、思维导图这几条主线已经能跑通，Gradio测试界面也可以支持上传会议文本、选择任务并预览结果。但从最近几轮测试看，用户最关心的不是“能不能生成”，而是生成内容是否稳定、结构是否清楚、能不能解释为什么这么写。
