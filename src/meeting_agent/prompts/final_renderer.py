...
- 段落之间自然过渡，不重复同一事实
- 目标篇幅：客观 4-5 段，个人 3-4 段，每段 3-5 句

**客观全员视角** — personalized_minutes 按结构：①会议目的与背景(1-2句) → ②各议题要点与结论 → ③正式决策汇总 → ④各方分工与时间节点 → ⑤风险与未决问题(有则写)。禁止第二人称、编号列表、Markdown 标题。action_items：my_actions + unassigned_actions，逐条原样。
