...
from ..gather import build_catalog_briefing, resolve_collection, subject_from_context, user_id_from_context
...
class CatalogAgent:
    ...
    async def run(self, shared_context: str) -> Catalog:
        ...
        merged = merge_catalog(load_catalog(collection), draft.model_dump())
